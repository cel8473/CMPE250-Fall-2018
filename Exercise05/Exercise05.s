;            CMPE 250 Exercise Five
;****************************************************************
;Name:  Chris Larson
;Date:  25 September 2018
;Class:  CMPE-250
;Section:  Section 02, Tuesday 2pm
;---------------------------------------------------------------
...
;****************************************************************
;Include files
            GET  MKL46Z4.asm     ;Included by start.s
...
;>>>>> begin main program code <<<<<
		BL INIT				;Runs the initial loop that sets up the UART
Start
		BL GETCHAR			;Receives the character and puts it into R0
		SUBS R0,R0,#1		;Subtracts 1 from R0
		BL PUTCHAR			;Transmits the character from R0
		B Start				;Runs the loop until the user exits the terminal
